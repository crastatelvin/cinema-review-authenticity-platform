...
class TrainConfig:
    train_csv: str
    valid_csv: str
    output_dir: str = "artifacts/distilbert_fake_review"
    text_col: str = "text"
    label_col: str = "label"
...
def train_distilbert(config: TrainConfig) -> dict:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default="artifacts/distilbert_fake_review")
